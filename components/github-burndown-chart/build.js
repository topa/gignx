...
var async, config, regex, render, repo, route, _;
...
require.register("app/modules/config.js", function(exports, require, module){
...
require.register("app/modules/graph.js", function(exports, require, module){
var Tip, d3, reg, _,
  __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
...
module.exports = {
  ...
  'ideal': function(a, b, off_days, total, cb) {
    ...
    _ref1 = _.map(a.match(reg.datetime)[1].split('-'), function(v) {
      return parseInt(v);
  ...
  'render': function(_arg, cb) {
    ...
    _ref = document.querySelector('#graph').getBoundingClientRect(), height = _ref.height, width = _ref.width;
    margin = {
      top: 30,
      right: 30,
      bottom: 40,
    ...
    svg.selectAll("a.issue").data(actual.slice(1)).enter().append('svg:a').attr("xlink:href", function(_arg1) {
      ...
      radius = _arg1.radius;
      return 5;
    }).on('mouseover', function(_arg1) {
      var date, div, number, points, title;
      date = _arg1.date, points = _arg1.points, title = _arg1.title, number = _arg1.number;
      ...
      return tooltip.show('#tooltip');
    }).on('mouseout', function(d) {
      return tooltip != null ? tooltip.hide(200) : void 0;
    });
    return cb(null);
  }
};
...
require.register("app/modules/issues.js", function(exports, require, module){
var async, reg, req, _;
...
require.register("app/modules/regex.js", function(exports, require, module){
module.exports = {
...
require.register("app/modules/request.js", function(exports, require, module){
var request, respond, sa, _;
...
request = function(_arg, query, noun, cb) {
  ...
  req = sa.get("" + protocol + "://" + host + "/repos/" + path + "/" + noun + "?" + q).set('Content-Type', 'application/json').set('Accept', 'application/vnd.github.raw');
  if (token) {
...
require.register("app/modules/render.js", function(exports, require, module){
...
require.register("app/modules/repo.js", function(exports, require, module){
var async, graph, issues, milestones, regex, render, _;
...
require.register("app/templates/error.js", function(exports, require, module){
...
require.register("app/templates/graph.js", function(exports, require, module){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.register("app/templates/info.js", function(exports, require, module){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.register("app/templates/label.js", function(exports, require, module){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.register("app/templates/loading.js", function(exports, require, module){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.register("app/templates/progress.js", function(exports, require, module){
module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
...
require.alias("visionmedia-superagent/lib/client.js", "app/deps/superagent/lib/client.js");
require.alias("visionmedia-superagent/lib/client.js", "app/deps/superagent/index.js");
...
require.alias("component-tip/index.js", "app/deps/tip/index.js");
require.alias("component-tip/template.js", "app/deps/tip/template.js");
...
require.alias("component-marked/lib/marked.js", "app/deps/marked/lib/marked.js");
require.alias("component-marked/lib/marked.js", "app/deps/marked/index.js");
